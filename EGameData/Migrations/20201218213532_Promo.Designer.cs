...
namespace EGamesData.Migrations
{
    ...
    [Migration("20201218213532_Promo")]
    partial class Promo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EGamesData.Models.Bingo", b =>
                {
                    ...
                    b.Property<int>("SubscriptionTrials")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EGamesData.Models.Promo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("UserWhoEnabledLastId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserWhoEnabledLastId");
            ...
            modelBuilder.Entity("EGamesData.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("WithdrawalPlaced")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EGamesData.Models.Withdrawal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NameOfWithdrawee")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EGamesData.Models.Promo", b =>
                {
                    b.HasOne("EGamesData.Models.User", "UserWhoEnabledLast")
                        .WithMany()
                        .HasForeignKey("UserWhoEnabledLastId");

                    b.Navigation("UserWhoEnabledLast");
                });
